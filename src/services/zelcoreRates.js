...
var zelcoreRates = {
  getAll() {
    return Promise.all([
      ...
      apiRequest(`https://min-api.cryptocompare.com/data/pricemulti?fsyms=QTUM,XEM,ONGAS,ONT,MIOTA,GAS,TRX,DGB,XLM,DOGE,EOS,ADA,XRP,DOCK,NEO,TRON,BTT,SAFE,BTH,GRS,XCASH,LEO,USDS,ENQ,FTM,0XBTC,AERGO,UBT,ILC,HEX,COMP,VIDT,DRGN,WBTC,OM,UNI,JST,BDX,FIRO,CAKE&tsyms=BTC&api_key=${apiKey}`),  //  3
